...
export const Leaderboard = ({ user, leaderboardData, onPlayerClick }) => {
  ...
  const displayStatus = user.level >= 100 ? 'LEGEND' : user.level >= 75 ? 'ELITE' : user.level >= 50 ? 'PRO' : user.level >= 25 ? 'GOLD' : 'ROOKIE';
          ...
          <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-12 mb-32">
            <div className="max-w-3xl">
              ...
              >
                ...
                <span className="text-[10px] font-black uppercase tracking-[0.5em] text-white/50">TOP PLAYERS RANKINGS</span>
              </motion.div>
              <motion.h1 
              ...
              >
                LEADER <br />
                <span className="text-white/20">BOARD</span>
              </motion.h1>
              <motion.p 
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
              ...
              >
                The top players in the community. Play games to earn points and climb the ranks.
              </motion.p>
            </div>
            ...
            >
              <div className="text-right pr-8 border-r border-white/10">
                <p className="text-[10px] font-black text-white/20 uppercase tracking-[0.3em] mb-2">MY RANK</p>
                <p className="text-5xl font-black text-white italic tracking-tighter">{displayRank}</p>
              </div>
              <div className="text-right">
                <p className="text-[10px] font-black text-white/20 uppercase tracking-[0.3em] mb-2">MY STATUS</p>
                <p className="text-5xl font-black text-white italic tracking-tighter">{displayStatus}</p>
              </div>
            </motion.div>
          </div>
