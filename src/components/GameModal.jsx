  ...
  return (
    ...
    >
      <motion.div 
        ...
        className="bg-black border border-white/10 rounded-[3rem] max-w-4xl w-full shadow-[0_40px_100px_rgba(0,0,0,0.8)] relative overflow-hidden flex flex-col md:flex-row"
      >
        {/* Background Glow */}
        <div className="absolute top-0 left-0 w-full h-full bg-[radial-gradient(circle_at_50%_0%,rgba(255,255,255,0.03)_0%,transparent_70%)] pointer-events-none"></div>
        ...
        <div className="w-full md:w-1/2 h-64 md:h-auto relative">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-t from-black via-transparent to-transparent md:bg-gradient-to-r md:from-transparent md:via-transparent md:to-black"></div>
        </div>
        ...
        <div className="w-full md:w-1/2 p-10 sm:p-14 flex flex-col relative z-10">
          <button 
            onClick={onClose}
            className="absolute top-8 right-8 w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-white/40 hover:text-white hover:bg-white/10 transition-all group"
          >
          ...
          <div className="mb-10">
            ...
            <p className="text-white/30 text-base leading-relaxed font-medium italic mb-8 line-clamp-4">{game.description}</p>
          </div>
